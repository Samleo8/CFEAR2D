 ...
 */
const std::vector<RadarImage> &RadarFeed::getCurrentFeed() const {
    return mSequence;
}
 ...
 */
size_t RadarFeed::getCurrentFrame() const {
 ...
 * @return Success status
 */
bool RadarFeed::getCurrentRadarImage(RadarImage &aRImage) const {
 ...
 */
bool RadarFeed::getVisualiser(OdometryVisualiser &aVis) const {
